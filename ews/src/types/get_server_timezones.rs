...
mod tests {
    ...
    fn serialize_get_server_time_zones_request() {
        ...
        let expected = r#"<GetServerTimeZones xmlns="http://schemas.microsoft.com/exchange/services/2006/messages" ReturnFullTimeZoneData="true"><Ids><t:Id>Eastern Standard Time</t:Id></Ids></GetServerTimeZones>"#;
